...
export const destContent: DestContent[] = [
  ...
  // ===========================================================
  {
    ...
    faq: [
      { q: 'Combien coûte un taxi Marseille → La Ciotat ?', a: 'Forfait fixe 140 € en journée et 180 € la nuit / dimanche / jours fériés (départ aéroport). Depuis Marseille centre, sur devis selon adresse.' },
  ...
  },
  {
    ...
    seoDescription: 'Transfert taxi Marseille → Saint-Cyr-sur-Mer (43 km, 40 min). Forfait fixe 150 € jour / 190 € nuit. Mercedes Classe V 7 pax. Dépose Plage des Lecques.',
    ...
    faq: [
      { q: 'Combien coûte un taxi Marseille → Saint-Cyr-sur-Mer ?', a: 'Forfait fixe 150 € en journée (7h–19h) et 190 € la nuit. Jusqu\'à 7 passagers en Mercedes Classe V.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi privé Marseille → Bandol (50 km, 45 min). Forfait 175 € jour / 225 € nuit. Dépose port, plage Renécros, vignobles AOC Bandol. Mercedes Classe V.',
    ...
    faq: [
      { q: 'Combien coûte un taxi Marseille → Bandol ?', a: 'Forfait fixe 175 € en journée et 225 € la nuit (7h-19h / 19h-7h). Tarif annoncé à la réservation pour jusqu\'à 7 passagers.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi privé Marseille → Sanary-sur-Mer (61 km, 50 min). Forfait 180 € jour / 235 € nuit. Mercedes Classe V 7 pax. Port pittoresque, marché provençal.',
    ...
    faq: [
      { q: 'Combien coûte un taxi Marseille → Sanary ?', a: 'Forfait fixe 180 € en journée et 235 € la nuit. Mercedes Classe V jusqu\'à 7 passagers.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi privé Marseille → Six-Fours-les-Plages (63 km, 55 min). Forfait 200 € jour / 250 € nuit. Embarcadère du Brusc, Cap Sicié, plages.',
    ...
    faq: [
      { q: 'Quel est le tarif Marseille → Six-Fours ?', a: 'Forfait fixe 200 € en journée et 250 € la nuit. Mercedes Classe V jusqu\'à 7 passagers.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi Marseille → La Seyne-sur-Mer (63 km, 55 min). Forfait 200 € jour / 255 € nuit. Plage des Sablettes, Fort Balaguier, Tamaris.',
    ...
    faq: [
      { q: 'Tarif Marseille → La Seyne ?', a: 'Forfait fixe 200 € en journée, 255 € la nuit. Jusqu\'à 7 passagers.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi privé Marseille → Hyères (85 km, 1h05). Forfait 245 € jour / 315 € nuit. Dépose vieille ville, port St-Pierre, embarcadère Îles d\'Or.',
    ...
    faq: [
      { q: 'Combien coûte Marseille → Hyères ?', a: 'Forfait fixe 245 € en journée et 315 € la nuit. Jusqu\'à 7 passagers.' },
  ...
  // ===========================================================
  {
    ...
    seoDescription: 'Taxi privé Marseille → La Londe-les-Maures (100 km, 1h15). Forfait 265 € jour / 340 € nuit. Côtes-de-Provence, port Miramar, plages.',
    ...
    faq: [
      { q: 'Tarif Marseille → La Londe ?', a: 'Forfait 265 € jour / 340 € nuit. Jusqu\'à 7 passagers.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi Marseille → Bormes-les-Mimosas (110 km, 1h20). Forfait 290 € jour / 370 € nuit. Village médiéval perché, plage Cabasson, mimosas en hiver.',
    ...
    faq: [
      { q: 'Forfait Marseille → Bormes ?', a: 'Forfait 290 € jour / 370 € nuit. Mercedes Classe V 7 pax.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi Marseille → Le Lavandou (113 km, 1h25). Forfait 290 € jour / 375 € nuit. 12 plages, Île du Levant, Port-Cros, embarcadère pour Îles d\'Or.',
    ...
    faq: [
      { q: 'Tarif Marseille → Le Lavandou ?', a: 'Forfait fixe 290 € jour / 375 € nuit. Mercedes Classe V 7 pax.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi privé Marseille → Rayol-Canadel-sur-Mer (125 km, 1h30). Forfait 440 € jour / 560 € nuit. Domaine du Rayol, plages secrètes.',
    ...
    faq: [
      { q: 'Forfait Marseille → Rayol ?', a: 'Forfait 440 € jour / 560 € nuit. Tarif élevé car trajet sinueux par Le Lavandou et Cavalière.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi Marseille → Cavalaire-sur-Mer (128 km, 1h35). Forfait 350 € jour / 445 € nuit. Plus longue plage de sable du Var.',
    ...
    faq: [
      { q: 'Forfait Marseille → Cavalaire ?', a: 'Forfait 350 € jour / 445 € nuit. Jusqu\'à 7 passagers.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi privé Marseille → La Croix-Valmer (132 km, 1h40). Forfait 225 € jour / 425 € nuit. Plages de Gigaro, Pardigon, Cap Lardier.',
    ...
    faq: [
      { q: 'Forfait Marseille → La Croix-Valmer ?', a: 'Forfait 225 € jour / 425 € nuit. Mercedes Classe V 7 pax.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi Marseille → Cogolin (135 km, 1h45). Forfait 315 € jour / 400 € nuit. Pipes Courrieu, Manufacture des tapis, vins Côtes-de-Provence.',
    ...
    faq: [
      { q: 'Forfait Marseille → Cogolin ?', a: 'Forfait 315 € jour / 400 € nuit.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi Marseille → Gassin (138 km, 1h45). Forfait 335 € jour / 435 € nuit. Plus Beaux Villages de France, vue golfe de Saint-Tropez.',
    ...
    faq: [
      { q: 'Forfait Marseille → Gassin ?', a: 'Forfait 335 € jour / 435 € nuit.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi Marseille → Ramatuelle (140 km, 1h50). Forfait 340 € jour / 420 € nuit. Pampelonne, village médiéval, Cap Camarat.',
    ...
    faq: [
      { q: 'Forfait Marseille → Ramatuelle ?', a: 'Forfait 340 € jour / 420 € nuit.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi privé Marseille → Fréjus (150 km, 1h55). Forfait 325 € jour / 415 € nuit. Cité romaine, arènes, port, plage de Saint-Aygulf.',
    ...
    faq: [
      { q: 'Forfait Marseille → Fréjus ?', a: 'Forfait 325 € jour / 415 € nuit. Mercedes Classe V 7 pax.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi privé Marseille → Saint-Raphaël (153 km, 2h). Forfait 335 € jour / 425 € nuit. Esterel, Calanques rouges, plages.',
    ...
    faq: [
      { q: 'Forfait Marseille → Saint-Raphaël ?', a: 'Forfait 335 € jour / 425 € nuit.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi privé Marseille → Cannes (163 km, 2h10). Forfait 310 € jour / 520 € nuit. Mercedes Classe V 7 pax. Croisette, Palais des Festivals, Îles Lérins.',
    ...
    faq: [
      { q: 'Forfait Marseille → Cannes ?', a: 'Forfait 310 € jour / 520 € nuit (tarif nuit majoré pour ce long trajet).' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi privé Marseille → Antibes (175 km, 2h20). Forfait 430 € jour / 540 € nuit. Mercedes Classe V 7 pax. Musée Picasso, Port Vauban, Cap d\'Antibes.',
    ...
    faq: [
      { q: 'Forfait Marseille → Antibes ?', a: 'Forfait 430 € jour / 540 € nuit.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi Marseille → Cagnes-sur-Mer (183 km, 2h25). Forfait 450 € jour / 565 € nuit. Haut-de-Cagnes médiéval, Musée Renoir, hippodrome.',
    ...
    faq: [
      { q: 'Forfait Marseille → Cagnes ?', a: 'Forfait 450 € jour / 565 € nuit.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi privé Marseille → Nice (196 km, 2h30). Forfait 470 € jour / 595 € nuit. Mercedes Classe V 7 pax. Promenade des Anglais, Vieux Nice, MAMAC.',
    ...
    faq: [
      { q: 'Forfait Marseille → Nice ?', a: 'Forfait 470 € jour / 595 € nuit. Mercedes Classe V 7 pax.' },
  ...
  // ===========================================================
  {
    ...
    faq: [
      { q: 'Forfait Marseille → Aubagne ?', a: 'Forfait fixe 115 € en journée (départ aéroport). Depuis Marseille centre, ~30 € au compteur.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi privé Marseille → Avignon (100 km, 1h05). Forfait 210 € jour / 265 € nuit. Mercedes Classe V 7 pax. Dépose Palais des Papes, gare TGV, festival.',
    ...
    faq: [
      { q: 'Forfait Marseille → Avignon ?', a: 'Forfait fixe 210 € jour / 265 € nuit. Mercedes Classe V 7 pax.' },
  ...
  },
  {
    ...
    seoDescription: 'Taxi Marseille → Arles (90 km, 1h). Forfait 190 € jour / 235 € nuit. Arènes romaines, Van Gogh, Camargue. Mercedes Classe V 7 pax.',
    ...
    faq: [
      { q: 'Forfait Marseille → Arles ?', a: 'Forfait 190 € jour / 235 € nuit.' },
